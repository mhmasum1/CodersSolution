    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="myform">
                    <form class="text-dark font-weight-bold" method="POST" enctype="multipart/form-data" action="#">
                    ...
                    <div class="error-text" id="success-text"></div>
                </div>
            </div>
        </div>
    </div>
